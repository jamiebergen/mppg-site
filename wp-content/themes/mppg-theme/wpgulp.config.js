...
module.exports = {
	...
	// Project options.
	projectURL: 'mppglocal.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Images options.
	imgSRC: './images/raw/**/*.{png,jpg,gif,svg}', // Source folder of images which should be optimized and watched. You can also specify types e.g. raw/**.{png,jpg,gif} in the glob.
	...
	// Translation options.
	textDomain: 'mppg-theme', // Your textdomain here.
	translationFile: 'mppg-theme.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Mppg_Theme', // Package name.
	bugReport: 'https://jamiebergen.com/', // Where can users report bugs.
	lastTranslator: 'Jamie Bergen <jamie.bergen@gmail.com>', // Last translator Email ID.
	team: 'Jamie Bergen <jamie.bergen@gmail.com>', // Team's Email ID.
